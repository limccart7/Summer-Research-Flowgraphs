...
class fileread_tests(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fileread_tests")
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_char*1, '/home/ubuntu/Desktop/Summer-Research-Flowgraphs/LoRa BER Testing/tx_test_csv.txt', False, 0, 0)
...
def main(top_block_cls=fileread_tests, options=None):
